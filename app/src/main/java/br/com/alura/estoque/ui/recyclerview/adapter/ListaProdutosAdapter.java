...
public class ListaProdutosAdapter extends
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView campoPrice;
        private final TextView campoQuantity;
        private final TextView campoUnity;
        private final TextView campoDescription;
        private final TextView campoCodProdt;
        private final TextView campoGtin;
        private final TextView campoRfid;
        private final TextView campoNameCat;
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            campoName = itemView.findViewById(R.id.produto_item_nome);
            campoPrice = itemView.findViewById(R.id.produto_item_preco);
            campoQuantity = itemView.findViewById(R.id.produto_item_quantidade); // ADD na visualizacao
            campoUnity = itemView.findViewById(R.id.produto_item_unidade); // ADD na visualizacao
            campoDescription = itemView.findViewById(R.id.produto_item_descricao); // ADD na visualizacao
            campoCodProdt = itemView.findViewById(R.id.produto_item_codProdt); // ADD na visualizacao
            campoGtin = itemView.findViewById(R.id.produto_item_GTIN); // ADD na visualizacao
            campoRfid = itemView.findViewById(R.id.produto_item_RFID); // ADD na visualizacao
            campoNameCat = itemView.findViewById(R.id.produto_item_nomeCat); // ADD na visualizacao
        ...
        void vincula(Produto produto) {
            ...
            campoName.setText(produto.getName());
            campoPrice.setText(formataParaMoeda(produto.getPrice()));
            campoQuantity.setText(String.valueOf(produto.getQuantity()));
            campoUnity.setText(produto.getUnity());
            campoDescription.setText(produto.getDescription());
            campoCodProdt.setText(produto.getProductCode());
            campoGtin.setText(produto.getGtin());
            campoRfid.setText(produto.getRfid());
            campoNameCat.setText(produto.getName_categorie());
